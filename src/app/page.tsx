  ...
  return (
    <div className="min-h-dvh flex justify-center gap-16 flex-col">
      <div className="flex flex-col gap-8 items-center md:items-start">
        ...
        <h1 className="text-4xl text-center leading-none font-heading font-medium flex flex-col md:text-left">
      ...
      <div className="flex gap-5 items-stretch flex-col md:flex-row">
        <div className="flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-blue font-semibold text-xs flex items-center gap-2">
          ...
          <p className="text-gray-300 leading-relaxed text-sm md:text-base">
            ...
            criar soluçoes inovadoras e compartilhar conhecimento. Vamos
            mergulhar nas tendências mais recentes em desenvolvimento de
            software, arquitetura de sistemas e tecnologias emergentes, com
            palestras, workshops e hasckatons.
            <br />
            <br />
            Dias 15 a 17 de março | Das 18h às 22h | online & gratuito
          </p>
        </div>
